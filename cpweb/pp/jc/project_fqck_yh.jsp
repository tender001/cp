...
<link href="/css/k3.css"  rel="stylesheet" type="text/css" />
<link href="/css/new159cai.css"  rel="stylesheet" type="text/css" />
<title>发起单式合买-竞彩足球-159彩票网</title>
...
<script type="text/javascript" src="/jc/js/buy_form_yh_suc.js"></script>
</head>
<%
...
<div class="gm_msg">
 <table width="100%" border="0" cellspacing="0" cellpadding="0" id="yhdetail">
 <colgroup>
  <col width="115" />
  <col width="145" />
  <col width="300" />
  ...
  <tbody>
    <tr>
    <td colspan="4" class="tp">投注信息：投注<font>${beishu}</font>倍&nbsp;&nbsp;&nbsp;&nbsp; 过关方式：<font>${sgtype}</font></td>
...
for (int j=0;j<rownum;j++){
	...
	StringBuffer sb = new StringBuffer();
 	sb.append("<tr id=match"+j+"><td title=\""+mb.get(count).getItemid()+"\">"+mb.get(count).getMname()+"</td>");
 	sb.append("<td>"+mb.get(count).getBt()+"</td>");
	
 	sb.append("<td hn=hn"+count+">"+mb.get(count).getHn());
 	if (playid.equalsIgnoreCase("72")|| playid.equalsIgnoreCase("70")){
 	sb.append("("+mb.get(count).getClose()+")");
 	}
 	sb.append(" VS "+mb.get(count).getGn()+"</td>");
	sb.append("<td sp=sp"+j+" style=\"display:none;\">"+mb.get(count).getB3()+"_"+mb.get(count).getB1()+"_"+mb.get(count).getB0()+"</td>");
	sb.append("<td  id=sp"+j+"></td>");
...
%>
  ...
  <tr><td colspan="4" class="tda"><a href="javascript:void(0);" id="show_detail">优化原单</a></td></tr>
  </tbody>
</table></div>
 <div class="tan_mid">
 <div class="b_th_col">
...
<div class="main_tan_yet" id="yhinfodiv" style="display:none;position:absolute;z-index:100001" >
<div class="tan_top">
 <div class="tan_top_l">
 </div>
 ...
 <div class="tan_top_r" onclick="javascript:$('#yhinfodiv').hide();$('.yclass_mask_panel').hide()">
 <a href="#"></a>
 </div>
</div>
<div class="tan_mid" id="yhdetailDIV" style="height:310px;overflow-y:auto">
<table border="0" class="bk_yd" cellpadding="0" cellspacing="0">
</table>
</div>
</div> 
</body>
