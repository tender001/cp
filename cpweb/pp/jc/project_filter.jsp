...
<title>发起过滤合买-竞彩足球-159彩票网</title>
...
<script type="text/javascript" src="/jc/js/buy_form_ds_suc_new.js"></script>
</head>
<%
...
<!-- 头部内容 --> 
<div id="container">
<div class=breadcrumb><p>您现在的位置：<a href="/" title="网上买彩票"><font>159彩票网</font></a> &gt; <a href="/dating/" title="购彩大厅"><font>购彩大厅</font></a> &gt; 竞彩足球</p></div>
<div class="gm_msg">
...
%>
 ...
 <div class="tan_mid">
 <div class="b_th_top1" id="all_form"><span>购买方式</span><b><input type="radio" name="radio_r" />代购</b><b class="cur"> <input type="radio" name="radio_r" />发起合买 </b></div>
 
<div class="b_th_col" id="dg_form" style="display:none">
<p class="red_pay">方案金额<font>${totalmoney}</font>元
<p id="userMoneyInfo">
	您尚未登录，请先<a href="javascript:void(0)" title="" onclick="Yobj.postMsg('msg_login')">登录</a>
</p>
<a href="javascript:void(0)" class="gm_but" id="dg_btn" name="dg_btn">确认无误，去付款</a>
<p style="font-size:14px;color:#444"><span class="hide_sp"><input type="checkbox" checked="checked"  id="agreement" /></span>我已阅读并同意《<a href="/help/help_yffwxy.html"  target="_blank">用户合买代购协议</a>》</p>
</div>
 
 <div class="b_th_col"  id="hm_form" style="display:none">
...
<span class="fa">方案标题</span><input type="text"  class="bt" id="title" maxlength="20" value="{$title}" default="竞彩足球合买"/><span class="fa_play">已输入<font id="title_word_count">0</font>个字符，最多可输入20个字符</span>
<span class="fa" style="clear:both">方案描述</span><textarea id="content" default="随缘,买彩票讲的是运气、缘分和坚持。">随缘！买彩票讲的是运气、缘分和坚持。</textarea><span class="fa_play">已输入<font id="content_word_count">0</font>个字符最多可输入200字符</span>
</div>
...
<p id="userMoneyInfo3333" style="display:none">
	您尚未登录，请先<a href="javascript:void(0)" title="" onclick="Yobj.postMsg('msg_login')">登录</a>
</p>
