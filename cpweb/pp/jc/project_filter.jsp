...
<title>竞彩足球过滤助手_网上购买_在线投注_网上合买_竞彩足球投注-159彩票网</title>
<meta name="Keywords" content="竞彩足球投注,竞彩足球代购,竞彩足球合买,竞彩足球投注,竞彩足球代购,竞彩足球合买" />
<meta name="Description" content="159彩票网竞彩足球频道为您提供竞彩足球（竞彩足球）购买、竞彩足球（竞彩足球）投注、竞彩足球（竞彩足球）合买、包括单式投注、复式投注等" />
...
<script type="text/javascript" src="/jc/js/buy_form_filter_suc.js"></script>
</head>
<body>
<!-- 头部内容 -->  
...
<!-- 导航内容 --> 
<div id="container">
<div class=breadcrumb><p>您现在的位置：<a href="/" title="网上买彩票"><font>159彩票网</font></a> &gt;<a href="/dating/" title="购彩大厅"><font>购彩大厅</font></a> &gt; <a href="/bj/" title="竞彩足球"><font>竞彩足球</font></a></p></div>
<div class="gm_msg">
		...
		try{
			...
			for (int j=0;j<items.length;j++){		
				...
				for(int i=0;i<mb.size();i++){
					if(mb.get(i).getItemid().equals(mid)){
						matchBean = mb.get(i);
						break;
					}
				}
				StringBuffer sb = new StringBuffer();
			 	sb.append("<tr><td>"+matchBean.getMname()+"</td>");
			 	
			 	sb.append("<td>"+matchBean.getBt()+"</td>");
			 	sb.append("<td>"+matchBean.getHn());
			 	if (lotid.equalsIgnoreCase("72")){
			 	sb.append("("+matchBean.getClose()+")");
			 	}
			 	sb.append(" VS "+matchBean.getGn()+"</td>");
			 	String select ="";
				...
				sb.append("<td>"+select+"</td>");
			 	...
			 	if(j==0){
			 		sb.append("<td rowspan="+(items.length+1)+" style=\"border-left:1px solid #ddd\"><a href=\"/cpdata/pupload/temp/"+rand+"_n.txt\" title=\"单式拆分方案下载\" target=\"_blank\" class=\"xga\">方案下载</a></td>");
			 	}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tbody id="optional_info_1" style="display: none;">
							...
							<tr>
								...
								<td><input type="text" id="title" maxlength="20" value="{$title}" default="竞彩足球合买" class="bt" ><span class="fa_play">已输入<font id="title_word_count">0</font>个字符。
								</span></td>
							</tr>
							<tr>
...
<input type="hidden" name="source" id="source" value="3">
</form>
</div>
