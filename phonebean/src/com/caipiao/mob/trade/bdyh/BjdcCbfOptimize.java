...
public class BjdcCbfOptimize extends AbstractBjdcOptimize {
...
//				result.put("desc", sdesc.substring(0, sdesc.length()-1));
	...
	protected String[] createItemToArray(MatchBean bean) {
		...
		for (int i=0;i<ss.length;i++) {
			...
			//lst.add(bean.expect + "=" + ss[i] + "~" + bean.mid + "=(" + result + ")[" +  spv + "]");
//			lst.add(bean.mid + "=" + ss[i] + "~" + bean.mid + "=(" + result + ")[" +  spv + "]");
			lst.add(bean.mid + "=" + ss[i] + "~" +bean.hn + "=(" + result + ")[" +  spv + "]");
		}
	...
	public static void main(String[] args) {
		BjdcCbfOptimize optimize = new BjdcCbfOptimize();
		String s = optimize.optimize("CBF|53=3:0,54=3:0,55=1:0/1:1/3:0", 7, 2, 3,"1","86","140812");
