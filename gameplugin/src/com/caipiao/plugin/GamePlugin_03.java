 ...
 * 
 */
public class GamePlugin_03 extends GamePluginAdapter {
...
//					}
	...
	public static void main(String[] args) throws Exception {
		GamePlugin_03 p = new GamePlugin_03();

		String code = "0,3,9:3:3;2,6:2:3;6,2,6:1:1";
		String[] cc = PluginUtil.splitter(code, ";");
		for(int i=0;i<cc.length;i++){
			GameCastCode gcc = p.parseGameCastCode(cc[i]);
			System.out.println(p.toPrintCode(gcc));
			System.out.println(p.keyBoardParser(cc[i], 1));
		}
	}
}
