 ...
 *
 */
public class GamePlugin_55 extends GamePluginAdapter {
...
//	private final static int[] maxs = { 6, 3, 4, 7, 10, 8, 9, 8, 11, 11, 8, 9 };
	...
	private final static int[] maxs = { 6, 11, 11, 11, 11, 11, 11, 8, 11, 11, 11, 11 };
	...
	public GamePlugin_55(){
		this.setGameID("55");
		this.setGameName("11选5(GD)");
		this.setGradeNum(12);
	}
...
//				}
	...
	public static void main(String[] args) throws Exception {
		GamePlugin_55 obj = new GamePlugin_55();
		String cc = "";
		cc = "07,08,09$03,04,05,06,10:06:05";// 选一前一直选
...
//			System.out.println(codes[i].getCastMoney());
		...
		String awardcode = "05,06,07,08,09";
