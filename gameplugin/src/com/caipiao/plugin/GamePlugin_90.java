 ...
 * 
 */
public class GamePlugin_90 extends GamePlugin_jc {
	...
	public byte getIntPlayType(String prefix) throws CodeFormatException {
		if ( prefix.equalsIgnoreCase("spf") ) {
			return JcItemCodeUtil.SPF;
		} else {
			throw new CodeFormatException(5, " 玩法不正确 必须是(SPF|号码|过关方式)", prefix);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		GamePlugin_90 plugin = new GamePlugin_90();
		try {			
			//胜平负
...
//			String scode = "SPF|110824010=3/1/0,110824011=1,110824012=1,110824013=1,110824014=1|5*10";

			String scode = "SPF|110824010=3/1/0,110824011=1,110824012=1,110824013=1,110824014=1|1*1";
