...
//胜负
public class GamePlugin_94 extends GamePlugin_lq {
	...
	public byte getIntPlayType(String prefix) throws CodeFormatException {
		if ( prefix.equalsIgnoreCase("sf") ) {
			return LqItemCodeUtil.SF;
		} else {
			throw new CodeFormatException(5, " 玩法不正确 必须是(SF|号码|过关方式)", prefix);
		}
	}
