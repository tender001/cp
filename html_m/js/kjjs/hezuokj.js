...
//    			if (obj) {d.rows.row
    				...
    				$.each(r,function(o,rt) {
        				...
        				if (row.gid=='80'){
    						...
    						$("#sfc_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						...
    						$("#dlt_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						...
    						$("#ssq_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						...
    						$("#sd_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						$("#sd_kjdate").html(row.awardtime);
    						$("#sd_code").html('<b>'+row.code.split(',').join('</b><b>')+'</b>');
    					}else if (row.gid=='53'){	
    						$("#pls_pid").html(row.pid+"期");	
    						$("#pls_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						$("#pls_kjdate").html(row.awardtime);	
    						$("#pls_code").html('<b>'+row.code.split(',').join('</b><b>')+'</b>');
    					}else if (row.gid=='52'){	
    						$("#plw_pid").html(row.pid+"期");	
    						$("#plw_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						$("#plw_kjdate").html(row.awardtime);
    						$("#plw_code").html('<b>'+row.code.split(',').join('</b><b>')+'</b>');
    					}else if (row.gid=='07'){	
    						$("#qlc_pid").html(row.pid+"期");		
    						$("#qlc_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
    						...
    						$("#qxc_pid").parent().parent().parent("a").attr("href","/kj/hzdetail.html?gid="+row.gid+"&pid="+row.pid+"");
