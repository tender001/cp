...
SYS_CONFIG.game.push(['58','快乐扑克','kp']);
...
SYS_CONFIG.game.push(['84','胜负过关(北单)','bd']);
...
SYS_CONFIG.getGameType = function(game){
	var btype = '';
	var count = SYS_CONFIG.game.length;
	for(var i = 0; i < count; i++){
		if(SYS_CONFIG.game[i][0]==game){
			btype = SYS_CONFIG.game[i][2];
			break;
		}
	}
	return btype;
