...
//大小分
public class GamePlugin_97 extends GamePlugin_lq {
	...
	public byte getIntPlayType(String prefix) throws CodeFormatException {
		if ( prefix.equalsIgnoreCase("dxf") ) {
			return LqItemCodeUtil.DXF;
		} else {
			throw new CodeFormatException(5, " 玩法不正确 必须是(DXF|号码|过关方式)", prefix);
		}
	}
