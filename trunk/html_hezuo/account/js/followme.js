		...
		Y.ajax({
			...
			data : data,
				...
				if (code == "0") {
					...
					if(tr==0){
						$("#fm_body").html("<tr><td colspan='7'>暂没有跟单记录</td></tr>");
					}else{
