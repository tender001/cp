...
public class FilterSF extends FilterBase{
...
//		String tmpcode = "1->3;2->0;4->0;6->0;8->3;9->0;29->0	1	2	7_1";
//		String tmpcode = "1→3,2→0,3→3,4→3,5→3,6→0,7→1	1	2	7_1";
		String tmpcode = "1→3,2→3,3→1,4→0,5→3,6→1";
	 ...
	 * 2013-08-17 新增  陈楚伟 
	 * 1->3;2->0;4->0;6->0;8->3;9->0;29->0	1	2	7_1
	 * @param bean
	 * @param result
	 * @param code
	 * @param codeMaps
