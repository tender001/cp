...
ESONCalendar={
    ...
    addStyle:function(){
        var cssText="#ESONCalendar_Win{border:1px #90C0CC solid;background:#A4B9D7;position:absolute;z-index:9999}";
        cssText+="#ESONCalendar_caption{padding:3px;background:#FFFFFF;width:170px;height:20px;}";
        cssText+=".esonclear{clear:both}";
        cssText+="#selMonth{margin-right:5px;width:50px}";
        cssText+="#ESONCalendar_table{background:#FFFFFF;border-collapse:collapse;border:1px solid #C0D0E8}";
        cssText+="#ESONCalendar_table th{border:1px #C0D0E8 solid}";
        cssText+="#ESONCalendar_week{background:#FFFFFF}";
        cssText+="#ESONCalendar_week th{font-size:12px;width:24px;height:24px}";
        ...
        cssText+="#ESONCalendar_foot{line-height:20px;text-align:center;font-size:12px;color:#003366;background:#C0D0E8}";
    ...
    addUI:function(date){
        ...
        this.foot.innerHTML=" "+this.y+"年"+this.m+"月"+this.d+"日";
    ...
    dateUp:function(date,first){
        ...
        for(var i=0;i<42;i++){
			...
			_this.onclick=function(){
                ...
                var mm=(ESONCalendar.m)*1<10?"0"+ESONCalendar.m:ESONCalendar.m;
        		var dd=(this.innerHTML)*1<10?"0"+this.innerHTML:this.innerHTML;
                ESONCalendar.onselect({y:ESONCalendar.y,m:mm,d:dd});
            };
        };
        return this;
    },
