...
Class('LoadExpect',{
	...
	sxds:function(data){
		 var html = [];
		 var tableTpl=['<colgroup><col width="40"><col width="60"><col width="50"><col width="77"><col width="4"><col width="85"><col width="80"><col width="80"><col width="80"><col width="80"><col width="25"><col></colgroup>',//0
	       '<tbody >'+
