    ...
    Class('LoadExpect',{
    	...
    	dxf:function(data){
   		 ...
   		 var tableTpl=['',//0对阵头
	           ...
	           '<td style="text-align: right; border-left:1px solid #ddd;" class=h_br><div class="dz_dv" title={$gn}><s class="s_left" style="padding-left:10px">&nbsp;</s><span class="eng b span_left"><em class="em_left" id="htid_{$itemid}">{$gn}</em><b class="b_left"> {$sp0}</b></span></div></td>'+
