...
Class.C('lot_data_wanfa',{
    116: '二星组选玩法：至少选择<em class="cm_red">2~6</em>个号码，猜中开奖号码的<em class="cm_red">最后2位</em>即中奖<em class="cm_red">50</em>元（不含对子）。',
    107: '一星直选玩法：至少选择<em class="cm_red">1</em>个号码，猜中开奖号<em class="cm_red">个位数</em>即中奖<em class="cm_red">10</em>元。',
    106: '二星直选玩法：每位至少选<em class="cm_red">1</em>个号码，与开奖号码<em class="cm_red">最后2位</em>按位相符即中奖<em class="cm_red">100</em>元。',
    105: '三星直选玩法：每位至少选择<em class="cm_red">1</em>个号码,与开奖号码<em class="cm_red">后3位</em>按位相符即中奖<em class="cm_red">1000</em>元。',
    104: '五星直选玩法：每位至少选<em class="cm_red">1</em>个号码，与开奖号的全部5个号码按位相符即中奖<em class="cm_red">100,000</em>元。 ',
    124: '五星通选玩法：每位至少选<em class="cm_red">1</em>个号码,与开奖号全部按位相符中<em class="cm_red">20440</em>元；与前三或后三位按位相符中<em class="cm_red">220</em>元；与前二或后二位按位相符中<em class="cm_red">20</em>元,兼中兼得。',// r4
