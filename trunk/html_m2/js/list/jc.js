        ...
        render: function() {
            ...
            if (!againstData.length) {
                ...
                l = againstData.length; i < l; i++) {
                    _out.push("<section>");
//                    _out.push('<div class="sfcTitle" style="display: none;">' + againstData[i].addesc + '<em class="up"></em></div>');
                    _out.push('<div class="sfcTitle" style="display: none;">' + againstData[i].addesc + '</div>');
                    _out.push("<div>");
                    ...
                    t1 = t.length; n < t1; n++) {
                        ...
                        if (lotteryPlayName == "spf" || lotteryPlayName == "rq") {
                            if ((((t[n].isale*1) & 1 << 4) == (1 << 4)) && lotteryType == "jczq" && lotteryPlayName == "spf" || (((t[n].isale*1) & 1 << 0) == (1 << 0)) && lotteryPlayName == "rq" || lotteryType == "bjdc") {
...
//                                _out.push("<li class=wangwei><em>" + name_ + "</em><p>" + t[n].mname + "</p><cite>" + t[n].et.substr(11, 5) + ' 截止</cite><i class="up down"></i></li>');
                                ...
                                if ((((t[n].idanguan*1) & 1 << 4) == (1 << 4)) && lotteryType == "jczq" && lotteryPlayName == "spf" || (((t[n].idanguan*1) & 1 << 3) == (1 << 3)) && lotteryPlayName == "rq") {
...
//                                    _out.push('<p class="spfpl"><span>赔率' + sp_[lotteryType == "jczq" ? 0 : 2] + '</span><span class="spfvs">赔率' + sp_[1] + "</span><span>赔率" + sp_[lotteryType == "jczq" ? 2 : 0] + "</span></p></li>");
                            ...
                            if ((((t[n].isale*1) & 1 << 1) == (1 << 1)) && lotteryType == "jczq" && lotteryPlayName == "bf" || (((t[n].isale*1) & 1 << 2) == (1 << 2)) && lotteryType == "jczq" && lotteryPlayName == "bqc" || lotteryType == "bjdc") {
                                _out.push('<ul class="sfcxs" data-id=' + t[n].itemid + ">");
                                _out.push("<li class=wangwei><em>" + name_ + "</em><p>" + t[n].mname + "</p><cite>" + t[n].et.substr(11, 5) + ' 截止</cite></li>');
                                _out.push("<li>");
                                ...
                                if ((((t[n].idanguan*1) & 1 << 2) == (1 << 2)) && lotteryType == "jczq" && lotteryPlayName == "bf" || (((t[n].idanguan*1) & 1 << 0) == (1 << 0)) && lotteryType == "jczq" && lotteryPlayName == "bqc") {
                            ...
                            if ((((t[n].isale*1) & 1 << 3) == (1 << 3)) || lotteryType == "bjdc") {
                                sp_ = t[n].jq_sp.split(",");
                            ...
                            if (lotteryPlayName == "sf" && (((t[n].isale*1) & 1 << 0) == (1 << 0)) || lotteryPlayName == "rf" && (((t[n].isale*1) & 1 << 1) == (1 << 1))) {
                                var rq_ = "";
                                ...
                                _out.push("<li>");
                                _out.push('<p class="spfzpk spfzpk2 ' + (t[n].hot == "yes" ? "spfzpk3": "") + '">');
                                if (lotteryPlayName == "rf" && (((t[n].idanguan*1) & 1 << 1) == (1 << 1))) {
...
//                            var jf = "暂无交锋记录";
//                            if (t[n].history) {
//                                jf = "两队近" + t[n].history.length + "次交锋，" + t[n].hn + "<cite>" + t[n].history + "</cite>"
//                            }
        ...
        container: function(el) {
            function main() {
                ...
                if (lotteryPlayName == "bf") {
                    ...
                    html += '<div class="clear"></div>					     </div>					  	<p class="gray">比分</p>					    <div class="competitions bfcom" i=2>					            	<span my-data=1:0><cite>1:0</cite><em>' + bf_sp[0] + "</em></span>					            	<span my-data=2:0><cite>2:0</cite><em>" + bf_sp[1] + "</em></span>					            	<span my-data=2:1><cite>2:1</cite><em>" + bf_sp[2] + "</em></span>					            	<span my-data=3:0><cite>3:0</cite><em>" + bf_sp[3] + "</em></span>					            	<span my-data=3:1><cite>3:1</cite><em>" + bf_sp[4] + "</em></span>					            	<span my-data=3:2><cite>3:2</cite><em>" + bf_sp[5] + "</em></span>					            	<span my-data=4:0><cite>4:0</cite><em>" + bf_sp[6] + "</em></span>					            	<span my-data=4:1><cite>4:1</cite><em>" + bf_sp[7] + "</em></span>					            	<span my-data=4:2><cite>4:2</cite><em>" + bf_sp[8] + "</em></span>					                <span my-data=5:0><cite>5:0</cite><em>" + bf_sp[9] + '</em></span>					                <span my-data=5:1 style="border-bottom:none"><cite>5:1</cite><em>' + bf_sp[10] + '</em></span>					                <span my-data=5:2 style="border-bottom:none"><cite>5:2</cite><em>' + bf_sp[11] + '</em></span>					            	<span my-data=9:0 style="border-bottom:none" class="bflast"><cite>胜其它</cite><em>' + bf_sp[12] + '</em></span>					                <div class="clear"></div>					    </div>					    <div class="competitions bfcom" i=2>					            	<span my-data=0:0 style="border-bottom:none"><cite>0:0</cite><em>' + bf_sp[13] + '</em></span>					            	<span my-data=1:1 style="border-bottom:none"><cite>1:1</cite><em>' + bf_sp[14] + '</em></span>					            	<span my-data=2:2 style="border-bottom:none"><cite>2:2</cite><em>' + bf_sp[15] + '</em></span>					            	<span my-data=3:3 style="border-bottom:none"><cite>3:3</cite><em>' + bf_sp[16] + '</em></span>					            	<span my-data=9:9 style="border-bottom:none" class="bflast"><cite>平其它</cite><em>' + bf_sp[17] + '</em></span>		            	<div class="clear"></div></div>				        <div class="competitions bfcom" i=2>					            	<span my-data=0:1><cite>0:1</cite><em>' + bf_sp[18] + "</em></span>					            	<span my-data=0:2><cite>0:2</cite><em>" + bf_sp[19] + "</em></span>					            	<span my-data=1:2><cite>1:2</cite><em>" + bf_sp[20] + "</em></span>					            	<span my-data=0:3><cite>0:3</cite><em>" + bf_sp[21] + "</em></span>					            	<span my-data=1:3><cite>1:3</cite><em>" + bf_sp[22] + "</em></span>					            	<span my-data=2:3><cite>2:3</cite><em>" + bf_sp[23] + "</em></span>					            	<span my-data=0:4><cite>0:4</cite><em>" + bf_sp[24] + "</em></span>					            	<span my-data=1:4><cite>1:4</cite><em>" + bf_sp[25] + "</em></span>					            	<span my-data=2:4><cite>2:4</cite><em>" + bf_sp[26] + "</em></span>					                <span my-data=0:5><cite>0:5</cite><em>" + bf_sp[27] + "</em></span>					                <span my-data=1:5><cite>1:5</cite><em>" + bf_sp[28] + "</em></span>					                <span my-data=2:5><cite>2:5</cite><em>" + bf_sp[29] + '</em></span>					            	<span my-data=0:9 class="bflast"><cite>负其它</cite><em>' + bf_sp[30] + '</em></span>					                <div class="clear"></div>					    </div>					    <p class="gray">总进球</p>					    <div class="competitions bfcom htzjq" i=3>					            	<span my-data=0><cite>0球</cite><em>' + jq_sp[0] + "</em></span>					            	<span my-data=1><cite>1球</cite><em>" + jq_sp[1] + "</em></span>					            	<span my-data=2><cite>2球</cite><em>" + jq_sp[2] + "</em></span>					            	<span my-data=3><cite>3球</cite><em>" + jq_sp[3] + "</em></span>					            	<span my-data=4><cite>4球</cite><em>" + jq_sp[4] + "</em></span>					            	<span my-data=5><cite>5球</cite><em>" + jq_sp[5] + "</em></span>					            	<span my-data=6><cite>6球</cite><em>" + jq_sp[6] + "</em></span>					            	<span my-data=7><cite>7+球</cite><em>" + jq_sp[7] + '</em></span>					                <div class="clear"></div>					    </div>					    <p class="gray">半全场</p>					    <div class="competitions bfcom htcom" i=4>					            	<span my-data=3-3><cite>胜胜</cite><em>' + bqc_sp[0] + "</em></span>					            	<span my-data=3-1><cite>胜平</cite><em>" + bqc_sp[1] + "</em></span>					            	<span my-data=3-0><cite>胜负</cite><em>" + bqc_sp[2] + "</em></span>					            	<span my-data=1-3><cite>平胜</cite><em>" + bqc_sp[3] + "</em></span>					            	<span my-data=1-1><cite>平平</cite><em>" + bqc_sp[4] + "</em></span>					            	<span my-data=1-0><cite>主负</cite><em>" + bqc_sp[5] + "</em></span>					            	<span my-data=0-3><cite>负胜</cite><em>" + bqc_sp[6] + "</em></span>					            	<span my-data=0-1><cite>负平</cite><em>" + bqc_sp[7] + "</em></span>					            	<span my-data=0-0><cite>负负</cite><em>" + bqc_sp[8] + '</em></span>					                <div class="clear"></div>					    </div></article>						<div class="zfTrue zfTrue2 clearfix"><a href="javascript:;" class="zfqx" id=tc_cancel>取 消</a><a id=tc_ok href="javascript:;">确 定</a></div>'
                }
                $("#tc_content").html(html);
                if (lotteryPlayName == "hh" || lotteryPlayName == "bf") {
                    var h_ = document.body.clientHeight * .9 - $("#tc").height() * 2;
                    $("#tc_c").css({
                        height: h_ + "px"
                    });
                    $("#tc").css({
                    ...
                    var h_ = (document.body.clientHeight - $("#tc").height()) / 2;
                    $("#tc").css({
                        top: h_ + "px"
                    })
                }
    ...
    var o = {
        pageGo: {
            goBack: function() {
                ...
                var url_ = "";
                if (lotteryType == "jczq") {
                    href_ = "/kj/jingcai.html?gid=jczq"
                	url_ = "/help/jc_help.html";
                } else if (lotteryType == "jclq") {
                    href_ = "/kj/jingcai.html?gid=jclq"
                	url_ = "/help/lc_help.html";
                } else {
                    href_ = "/kj/jingcai.html?gid=bjdc"
...
//                    title: lotteryInfo[lotteryType] + "·" + lotteryInfo[lotteryPlayName],
                    ...
                    {
                        name: "合买跟单",
                        url: "/hemai/index.html?lotid==" + CP.Util.lot(contrast[lotteryType][lotteryPlayName].gid, 2),
                        cur: false
                    },
                    {
                        name: "开奖结果",
...
var $_leaguename  = [];
$_leaguename.push([ 1, "日本联赛杯","日联杯"]);
$_leaguename.push([ 2, "亚洲冠军联赛","亚冠"]);
$_leaguename.push([ 3, "意大利甲级联赛","意甲"]);
$_leaguename.push([ 4, "瑞典超级联赛","瑞超"]);
$_leaguename.push([ 5, "俄罗斯超级联赛","俄超"]);
$_leaguename.push([ 6, "苏格兰超级联赛","苏超"]);
$_leaguename.push([ 7, "英格兰足总杯","英足总杯"]);
$_leaguename.push([ 8, "南美解放者杯","解放者杯"]);
$_leaguename.push([ 9, "西班牙甲级联赛","西甲"]);
$_leaguename.push([ 10, "阿根廷甲级联赛","阿甲"]);
$_leaguename.push([ 11, "美国职业大联盟","美职"]);
$_leaguename.push([ 12, "巴西圣保罗州锦赛","巴圣锦标赛"]);
$_leaguename.push([ 13, "中北美冠军联赛","中北美联赛"]);
$_leaguename.push([ 14, "英格兰超级联赛","英超"]);
$_leaguename.push([ 15, "法国甲级联赛","法甲"]);
$_leaguename.push([ 16, "德国甲级联赛","德甲"]);
$_leaguename.push([ 17, "英格兰联赛杯","英联赛杯"]);
$_leaguename.push([ 18, "欧洲冠军联赛","欧冠"]);
$_leaguename.push([ 19, "巴西甲级联赛","巴甲"]);
$_leaguename.push([ 20, "荷兰甲级联赛","荷甲"]);
$_leaguename.push([ 21, "荷兰乙级联赛","荷乙"]);
$_leaguename.push([ 22, "法国乙级联赛","法乙"]);
$_leaguename.push([ 23, "德国乙级联赛","德乙"]);
$_leaguename.push([ 24, "英格兰冠军联赛","英冠"]);
$_leaguename.push([ 25, "英格兰甲级联赛","英甲"]);


$_getleagueshort = function(f,n) {
	if (typeof(n)=='undefined'){n=1;};
	for ( var i = 0; i < $_leaguename.length; i++) {
		if ($_leaguename[i][1] == f) {
			return $_leaguename[i][n];
		}
	}
};
function resetPage() {
