...
public class TransactionUtil {
	...
	public static String[] showCmemo(String ibiztype,String cmemo) {
		...
		if (memoarr.length>1){	
			...
			case 101:
			case 103:
				memo[0]=GameUtil.getGameDetailName(memoarr[0])+getTransactionName(ibiztype);
				memo[1] = memoarr[0]+"_"+memoarr[1];
				break;
			case 105:
				memo[0]=GameUtil.getGameDetailName(memoarr[0])+getTransactionName(ibiztype);
				memo[1] = memoarr[0]+"_"+StringUtil.splitter(memoarr[1], "[")[0];
				break;
			case 201:		
			case 202:
			case 203:	
			...
			case 212:
				...
				memo[0]=GameUtil.getGameDetailName(NT[0])+getTransactionName(ibiztype);
				memo[2] = memoarr[0];
				break;	
			case 204:	
				memo[0]=GameUtil.getGameDetailName(memoarr[0])+getTransactionName(ibiztype);
