...
Class( 'ConfirmForm', {
	...
	check : function() {
		...
		} else if (this.param.initems == 0 && this.param.matches.length <18) {
		...
		} else if (this.param.beishu <= 0 || this.param.beishu > 99) {
