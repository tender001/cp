...
Class( 'BuyForm', {
	...
	swapcode:function(param){
		...
		case 94 :    //胜负
			...
			break;
		case 95 :    //让分胜负
			Class.config('playName', 'rfsf');
			Class.config('codeValue', ['胜', '负']);
			Class.config('playName_1', 'RFSF');
			Class.config('codeValue_1', ['3', '0']);
			param.lotid=95;
			break;
		case 96 :    //胜分差
			Class.config('playName', 'sfc');
			Class.config('codeValue', [ '01', '02', '03', '04', '05', '06', '11', '12', '13', '14', '15', '16']);
			Class.config('playName_1', 'SFC');
			Class.config('codeValue_1', [ '01', '02', '03', '04', '05', '06', '11', '12', '13', '14', '15', '16']);
			param.lotid=96;
			break;
		case 97 :    //大小分
			Class.config('playName', 'dxf');
			Class.config('codeValue', ['大分', '小分']);
			Class.config('playName_1', 'DXF');
			Class.config('codeValue_1', ['3', '0']);
			param.lotid=97;
			break;
		default :
          ...
          if (swap){
        	  ...
        	  if (param.ishm==0){
             	 param_new={
         				 ...
         				 fflag:0,// 是否文件
         				 type:0,// 方案类型
         				 name:param.ishm==0?"竞彩代购":param.title,// 方案标题
         				 desc:param.ishm==0?"竞彩代购":param.content,// 方案描叙
