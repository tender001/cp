	...
	cbf:function(data){
		...
		r.each(function(row,i){
			...
			if (out_of_date&&row.rz!=''){//已经开出赛果的
				...
				row.sp90str='<span class="'+(out_of_date?'red':'')+'">'+row.sp90+'</span>';
				row.sp10str='<span class="'+(out_of_date?'red':'')+'">'+row.sp10+'</span>';
				row.sp20str='<span class="'+(out_of_date?'red':'')+'">'+row.sp20+'</span>';
				row.sp21str='<span class="'+(out_of_date?'red':'')+'">'+row.sp21+'</span>';
				row.sp30str='<span class="'+(out_of_date?'red':'')+'">'+row.sp30+'</span>';
				row.sp31str='<span class="'+(out_of_date?'red':'')+'">'+row.sp31+'</span>';
				row.sp32str='<span class="'+(out_of_date?'red':'')+'">'+row.sp32+'</span>';
				row.sp40str='<span class="'+(out_of_date?'red':'')+'">'+row.sp40+'</span>';
				row.sp41str='<span class="'+(out_of_date?'red':'')+'">'+row.sp41+'</span>';
				row.sp42str='<span class="'+(out_of_date?'red':'')+'">'+row.sp42+'</span>';

				row.sp99str='<span class="'+(out_of_date?'red':'')+'">'+row.sp99+'</span>';
				row.sp00str='<span class="'+(out_of_date?'red':'')+'">'+row.sp00+'</span>';
				row.sp11str='<span class="'+(out_of_date?'red':'')+'">'+row.sp11+'</span>';
				row.sp22str='<span class="'+(out_of_date?'red':'')+'">'+row.sp22+'</span>';
				row.sp33str='<span class="'+(out_of_date?'red':'')+'">'+row.sp33+'</span>';
				
				row.sp09str='<span class="'+(out_of_date?'red':'')+'">'+row.sp09+'</span>';
				row.sp01str='<span class="'+(out_of_date?'red':'')+'">'+row.sp01+'</span>';
				row.sp02str='<span class="'+(out_of_date?'red':'')+'">'+row.sp02+'</span>';
				row.sp12str='<span class="'+(out_of_date?'red':'')+'">'+row.sp12+'</span>';
				row.sp03str='<span class="'+(out_of_date?'red':'')+'">'+row.sp03+'</span>';
				row.sp13str='<span class="'+(out_of_date?'red':'')+'">'+row.sp13+'</span>';
				row.sp23str='<span class="'+(out_of_date?'red':'')+'">'+row.sp23+'</span>';
				row.sp04str='<span class="'+(out_of_date?'red':'')+'">'+row.sp04+'</span>';
				row.sp14str='<span class="'+(out_of_date?'red':'')+'">'+row.sp14+'</span>';
				row.sp24str='<span class="'+(out_of_date?'red':'')+'">'+row.sp24+'</span>';
			}
		...
		this.ajax({
				url:"/cpdata/omi/bjdc/"+ex+"/"+ex+"_odds.xml",
                     ...
                     this.qXml('//row', data.xml, function (u, i){
                    	 Y.get("#match"+u.items.xid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=main&lid="+u.items.lid+"&sid="+u.items.sid+"&cid="+u.items.cid+"&t="+u.items.t);
                    	 ...
                    	 Y.get("#ox"+u.items.xid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=analysis&action=index&mid="+u.items.oddsmid+"&sit=4&lotyid=5");
                    	 Y.get("#oz"+u.items.xid).attr("href","http://odds.caipiao.gucheng.com/index.php?controller=detail&action=index&mid="+u.items.oddsmid+"&sit=1&lotyid=5");
                    	 Y.get("#oy"+u.items.xid).attr("href","http://odds.caipiao.gucheng.com/index.php?controller=detail&action=index&mid="+u.items.oddsmid+"&sit=2&lotyid=5");
