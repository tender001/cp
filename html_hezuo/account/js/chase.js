Class({
	 ...
	 index:function (config){
		    var html='<select name="lotid" id="lotid">';
	    ...
	    submitbind:function(){
	    	...
	    	this.get('#submit').click(function() {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
	    			...
	    			P.getlist(Y.get("#begintime").val(), Y.get("#endtime").val(), Y.get("#lotid").val(),seltype,pn, ps, tp, tr);
	    		});
		...
		nodata = function(){
			Y.get("#div1").show();
			Y.get("#div2").html("<tr><td colspan='10'>查询无数据</td></tr>");
			Y.get("#page_div").hide();
		};
