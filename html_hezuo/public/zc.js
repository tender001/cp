					...
					url:ourl,
	                     ...
	                     this.qXml('//row', data.xml, function (u, i){
	                    	 if(Class.C('lot_gid')==3){//半全场
	                    		 htid=(u.items.xid)/2;
	                    		 $("#mn"+htid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=main&lid="+u.items.lid+"&sid="+u.items.sid+"&cid="+u.items.cid+"&t=2");
//	                    		 if((u.items.xid)%2==0){
	                    			
//	                    			 $("#mn"+htid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=main&lid="+u.items.lid+"&sid="+u.items.sid+"&cid="+u.items.cid+"&t=1");
	                    			 $("#hteam"+htid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=teaminfo&lid="+u.items.lid+"&sid="+u.items.sid+"&tid="+u.items.htid);
	 	            				 $("#vteam"+htid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=teaminfo&lid="+u.items.lid+"&sid="+u.items.sid+"&tid="+u.items.gtid);
	 	            				 $("#ox"+htid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=analysis&action=index&mid="+u.items.oddsmid+"&sit=4");
	 	            				 $("#oz"+htid).attr("href","http://odds.caipiao.gucheng.com/index.php?controller=detail&action=index&mid="+u.items.oddsmid+"&sit=1");
	 	            				 $("#oy"+htid).attr("href","http://odds.caipiao.gucheng.com/index.php?controller=detail&action=index&mid="+u.items.oddsmid+"&sit=2");
//	                    		 }
	            				 ...
	            				 if($("#b0"+u.items.xid).html()=="0.00"){$("#b0"+u.items.xid).html(parseFloat(u.items.oa).rmb(false,2));}
	             				 ...
	             				 $("#mn"+u.items.xid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=main&lid="+u.items.lid+"&sid="+u.items.sid+"&cid="+u.items.cid+"&t=2");
	             				 $("#hteam"+u.items.xid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=teaminfo&lid="+u.items.lid+"&sid="+u.items.sid+"&tid="+u.items.htid);
	            				$("#vteam"+u.items.xid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=teaminfo&lid="+u.items.lid+"&sid="+u.items.sid+"&tid="+u.items.gtid);
	            				$("#ox"+u.items.xid).attr("href","http://info.caipiao.gucheng.com/index.php?controller=analysis&action=index&mid="+u.items.oddsmid+"&sit=4");
	            				$("#oz"+u.items.xid).attr("href","http://odds.caipiao.gucheng.com/index.php?controller=detail&action=index&mid="+u.items.oddsmid+"&sit=1");
	            				$("#oy"+u.items.xid).attr("href","http://odds.caipiao.gucheng.com/index.php?controller=detail&action=index&mid="+u.items.oddsmid+"&sit=2");
	            				//if(Class.C('lot_gid')==1){
