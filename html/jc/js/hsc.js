		...
		var tableTmpl=['<div class="main_tan_yet">'+
		 ...
		 switch (lotid) {
			...
			case "72" :    //让球胜平负
				...
				$("#bzgs").click(function(){
					Yobj.openUrl('/jc/bzgs/RQSPF.html',550,387)
				});
				break;
			case "93" :    //总进球数
				...
				$("#bzgs").click(function(){
					Yobj.openUrl('/jc/bzgs/JQS.html',550,387)
				});
				break;
			case "91" :    //比分
				$("#tzurl").attr('href','/jc/cbf.html');
				$("#bzgs").click(function(){
					Yobj.openUrl('/jc/bzgs/BF.html',550,387)
				});
				break;
			case "92" :    //半全场
			    ...
			    $("#bzgs").click(function(){
					Yobj.openUrl('/jc/bzgs/BQC.html',550,387)
				});
			    break;
		}	
	}
