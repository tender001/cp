    ...
    Class('LoadExpect',{
    	...
    	spf:function(data){
    		 ...
    		 var tableTpl=['<div class="sf-left dp-basic"  etimes="{$short_et}" gn="{$gn}" hn="{$hn}" zid="{$itemid}" mid="{$mid}">'
                 ...
                 +'</div>'
                 +'</div>'
                 +'</div>','<div class="sf-left dp-basic"  style="display: none;">'
                 +'<h2>{$hn}&nbsp;VS&nbsp;{$gn}</h2>'
                 +'<div class="bod">'
                 +'<p>'
    	...
    	rspf:function(data){
   		 ...
   		 var tableTpl=['<div class="sf-left dp-basic"  etimes="{$short_et}" gn="{$gn}" hn="{$hn}" zid="{$itemid}" mid="{$mid}">'
                ...
                +'</ul>'
                +'<dl>'
                +'<dd sp="{$sp3}" value="3" v="胜">{$lhn}&nbsp;{$closestr}<em>{$sp3}</em></dd>'
                +'<dd sp="{$sp1}" value="1" v="平">平局<em>{$sp1}</em></dd>'
                +'<dd sp="{$sp0}" value="0" v="负">{$lgn}<em>{$sp0}</em></dd>'
                +'</dl>'
                +'</div>'
                ...
                +'</ul>'
                +'<dl>'
                +'<dd class="un-time">{$lhn}&nbsp;{$closestr}<em>{$sp3}</em></dd>'
                +'<dd class="un-time">平局<em>{$sp1}</em></dd>'
    	...
    	bf:function(data){
   		 ...
   		 var tableTpl=['<div class="sf-left dp-basic"  etimes="{$short_et}" gn="{$gn}" hn="{$hn}" zid="{$itemid}" mid="{$mid}">'
                ...
                +'<div class="bod-m">'
                +'<div class="sf bf-sf">'
                +'<em sp="{$sp90}" value="胜其它" v="9:0">胜其它<i>{$sp90}</i></em>'
                ...
                +'</div>'
                +'<div class="sf bf-sf">'
                +'<em sp="{$sp99}" value="平其它" v="9:9">平其它<i>{$sp99}</i></em>'
                ...
                +'</div>'
                +'<div class="sf bf-sf">'
                +'<em sp="{$sp09}" value="负其它" v="0:9">负其它<i>{$sp09}</i></em>'
