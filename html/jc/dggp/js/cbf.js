    ...
    Class('Vs', {
        ...
        _init: function (){
            ...
            Y.get('#vsTable tr[isend=0]').hover(function (e, Y){//鼠标滑入滑出效果
    			...
    			this.children[8].style.backgroundColor = '#fffee6';
    ...
    Class('LoadExpect',{
    	...
    	cbf:function(data){
    		 ...
    		 var tableTpl=['',//0对阵头
               ...
               '<TBODY>'+
               '<TR style="DISPLAY:{$display}" class="{$classname}" lg="{$mname}" isend="{$end}" odds="{$ccbf}" pdate="{$itemid}" pendtime="{$enddate}" pname="{$itemid}" mid="{$mid}" zid="{$itemid}">'+
...
//                        }
                        ...
                        Y.get("#jjyh_form").attr("action", '/jc/jjyh_cbf.html');
