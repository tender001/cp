								...
								if (Class.C('lot_gid')==3){
									...
									for (var i=0;i<6;i++){		//半全场
										html += '<tr data-vs="'+vs[i*2][1]+','+vs[i*2][2]+' 半" name='+i+' onselectstart="return false">'
											...
											+'<td>[主] <a href="" target="_blank" id="hteam'+(i+1)+'" class="mtc_name"><em id="htid'+((i+1)*2-1)+'" class="ew_em">'+vs[i*2][1]+'</em></a><em></em></td>'
											+'<td>半场</td>'
											+'<td class="btn_a">3</td>'
											+'<td class="btn_a">1</td>'
											+'<td class="btn_a">0</td>'
											...
											+'</tr>'
											+'<tr data-vs="'+vs[i*2][1]+','+vs[i*2][2]+'  全" name='+i+'><td>[客] <a href="" target="_blank" id="vteam'+(i+1)+'" class="mtc_name"><em id="gtid'+((i+1)*2-1)+'" class="ew_em">'+vs[i*2][2]+'</em></a><em></em></td>'
											+'<td>全场</td>'
											+'<td class="btn_a">3</td>'
											+'<td class="btn_a">1</td>'
											+'<td class="btn_a">0</td>'
...
//										var b0 = (rt.b3==""?"--":(rt.b0+"00").slice(0,-2));
										...
										if (Class.C('lot_gid')==1){
											if ($('#playid').val() == '123'){//任九胆拖
												...
												+ '<td><em></em><a href="" target="_blank" id="hteam'+mid+'" class="mtc_name"><em id="htid'+mid+'" class="ew_em">'+hn+'</em></a> VS '
												+ '<a href="" target="_blank" id="vteam'+mid+'" class="mtc_name"><em id="gtid'+mid+'" class="ew_em">'+gn+'</em></a><em></em></td>'
												+ '<td class="btn_a">3</td>'
												+ '<td class="btn_a">1</td>'
												+ '<td class="btn_a">0</td>'
												...
												+ '<td>[主] <a href="" target="_blank" id="hteam'+mid+'" class="mtc_name"><em id="htid'+mid+'" class="ew_em">'+hn+'</em></a><em></em></td>'
												+ '<td class="btn_a">0</td>'
												+ '<td class="btn_a">1</td>'
												+ '<td class="btn_a">2</td>'
												+ '<td class="btn_a">3+</td>'
												...
												+ '<a href="" target="_blank" id="oz'+mid+'" class="mtc_name">欧</a></td>'
												+ '</tr>'
												+ '<tr data-vs="'+gn+'" name='+mid+'><td>[客] <a href="" target="_blank" id="vteam'+mid+'" class="mtc_name"><em id="gtid'+mid+'" class="ew_em">'+gn+'</em></a><em></em></td>'
												+ '<td class="btn_a">0</td>'
												+ '<td class="btn_a">1</td>'
												+ '<td class="btn_a">2</td>'
												+ '<td class="btn_a">3+</td>'
