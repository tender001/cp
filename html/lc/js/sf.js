    ...
    Class('LoadExpect',{
    	...
    	sf:function(data){
    		 ...
    		 var tableTpl=['',//0对阵头
		           ...
		           '<td style="text-align: right; border-left:1px solid #ddd;" class=h_br><div class="dz_dv" title={$gn} style="padding-left:10px"><s class="s_left">&nbsp;</s><span class="eng b span_left"><em class="em_left" id="htid_{$itemid}">{$gn}</em><b class="b_left"> {$sp0}</b></span></div></td>'+
