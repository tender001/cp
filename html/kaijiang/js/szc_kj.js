...
//									alert(i+"==="+acode.lenglength);
					...
					kjdengji='<table width="100%" border="0" cellpadding="0" cellspacing="0"><colgroup> <col width="110" /><col width="215" /><col width="215" /> <col /> </colgroup> <thead><tr> <td >奖项</td> <td>中奖注数(注)</td><td>每注奖金(元)</td> </tr>  </thead>';
