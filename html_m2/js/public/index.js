    ...
    info: function(fn) {
        ...
        $.ajax({
            ...
            success: function(xml) {
                ...
                if (c == "0") {
                    var r = R.find("row");
                    t.usermoney = r.attr("usermoeny");
                    t.ipacketmoney = r.attr("ipacketmoney");
                    fn(t)
                } else {
                    var agent = localStorage.getItem("agent");
                    if (agent == "3012") {
                        window.location.href = "http://lifepage.api.niuwan.cc/lotteryjump?addfrom=login&rnd=" + Math.random()
                    } else {
                        remove_alert();
        ...
        init: function() {
            ...
            function() {
                ...
                var param = {
                    ...
                    gid: lot_,
                    pid: CP.Data.pid,
                    codes: CP.Util.joinString(lot_, code),
                    muli: "1",
                    countMoney: "2",
                    orderType: "dg"
                };
